...
// File: hydro-token-and-server-raindrop/contracts/Ownable.sol
...
// File: hydro-token-and-server-raindrop/contracts/Raindrop.sol
...
contract Raindrop is Ownable {
   ...
   */
  function validateAuthentication(address _sender, uint _challenge, uint _partnerId) public returns (bool _isValid) {
